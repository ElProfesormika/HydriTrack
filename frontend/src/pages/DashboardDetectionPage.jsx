  ...
  return (
    <div className="page">
      <header className="page-header">
        <div>
          <h2>Dashboard detection & ML</h2>
          <p>
            Pilotage du modele d&apos;anomalies (IsolationForest / scores), probabilites de fuite et charge
            d&apos;evenements pour evaluer la fiabilite du systeme.
          </p>
        </div>
